...
let
  ...
  meta-master = {
    ...
    bootstrap = {
      filename = "zig-bootstrap-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "5227d16216f67f51445ee7f16e0bd723588d0766276e648405ff9bb7618096c7";
      size = 55249128;
    };
    ...
    loongarch64-linux = {
      filename = "zig-loongarch64-linux-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "63fe2d9ec3dae00b72d7bb4e2dcae2c133dc93c76e9a2eda81ec47a4e57a42cc";
      size = 52510812;
    };

    s390x-linux = {
      filename = "zig-s390x-linux-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "820e7257ffd4f630b3cd51cfaac1167cae406ca02832fe40f3c72feccbd4e592";
      size = 54930764;
    };

    x86_64-mingw32 = {
      filename = "zig-x86_64-windows-0.17.0-dev.131+73c51c142.zip";
      shasum = "dbfedab901b793ec6673b3c6cd5f3dcc24ad5034c8258ac642bde46399a4ba11";
      size = 97890098;
    };

    aarch64-mingw32 = {
      filename = "zig-aarch64-windows-0.17.0-dev.131+73c51c142.zip";
      shasum = "7d109b98ec2ca7f612af0c601c7bae0835d651bab8083c83b0eb59962ce43499";
      size = 93818396;
    };

    i686-mingw32 = {
      filename = "zig-x86-windows-0.17.0-dev.131+73c51c142.zip";
      shasum = "34126d17a22b25aaf75515982383ddea879dddd9ef14eeb136a161d6d112ef28";
      size = 99701777;
    };

    aarch64-freebsd = {
      filename = "zig-aarch64-freebsd-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "1b1dac312194230f846bfefab4e64a59e354e99c1ff92b285227632191deb19b";
      size = 51131680;
    };

    armv7l-freebsd = {
      filename = "zig-arm-freebsd-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "ceea360d0303547c40345f8bb44f60f1ce351481e070545837265f15b2752362";
      size = 52714508;
    };

    powerpc64le-freebsd = {
      filename = "zig-powerpc64le-freebsd-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "f781de8bfb17d79c11ce8fbfd3a3603623a7bd4d21d44c3a4053417946f463da";
      size = 55248516;
    };

    riscv64-freebsd = {
      filename = "zig-riscv64-freebsd-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "56da9582ddd7c25e35beab7eed521cdde88247e228bf82ca094b9445fb2baa48";
      size = 55393612;
    };
    ...
    aarch64-netbsd = {
      filename = "zig-aarch64-netbsd-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "7e856fe0e46ce30b5655338c8012d955d81ce7790c6238c1c6329369ffd73d2c";
      size = 51088164;
    };

    armv7l-netbsd = {
      filename = "zig-arm-netbsd-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "abd5badc6e674f0184a72a58ec3e9559b97b41c46b91c1996e09f02ede24719d";
      size = 53749844;
    };

    i686-netbsd = {
      filename = "zig-x86-netbsd-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "f8a65b0eb8cc5d97f73a1f285c38fb07c8c4ceafea956d1bfeccf1b984ec2132";
      size = 58763132;
    };

    x86_64-netbsd = {
      filename = "zig-x86_64-netbsd-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "d65cdb050bcbc4e4e8464bc57b635c700d1056d85c60b7bf2c0be3e177561339";
      size = 55502732;
    };

    aarch64-openbsd = {
      filename = "zig-aarch64-openbsd-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "7eebfaf2395c7f0ae2168ca07a3688f865317c6cd9ff0e6ca507b99b4271c346";
      size = 51564204;
    };

    armv7l-openbsd = {
      filename = "zig-arm-openbsd-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "54b916516c51c3ba38e80e75fe0b296eb614719dd947aec219d338fe7f8e9e5b";
      size = 52287192;
    };

    riscv64-openbsd = {
      filename = "zig-riscv64-openbsd-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "12bd18dd39fafbb417dc6bcfde37391eb2944e37885e2eec16d72632fecfc68b";
      size = 55714104;
    };

    x86_64-openbsd = {
      filename = "zig-x86_64-openbsd-0.17.0-dev.131+73c51c142.tar.xz";
      shasum = "deb1e97d7db49eba195b79a4c88f3465e44cc8e8093621fe4596f9f2ca15f211";
      size = 56919288;
    };
  };
  ...
  meta-0_16_0 = {
    ...
    armv7l-linux = {
      filename = "zig-arm-linux-0.16.0.tar.xz";
      shasum = "f85116bf2f9189bb6ae280c7f92f03b89c2551a88e17881c0c2df86bf4e42c50";
      size = 52122000;
    };

    riscv64-linux = {
      filename = "zig-riscv64-linux-0.16.0.tar.xz";
      shasum = "bc069b0f2f568f54bafbdfc1d65b12fd386ed6a652044a37aee6a4f72f14076e";
      size = 55313616;
    };

    powerpc64le-linux = {
      filename = "zig-powerpc64le-linux-0.16.0.tar.xz";
      shasum = "18800b45c08bf40b335ca5ab79aea70aca287ca969036e938155772becaeebeb";
      size = 55242728;
    };

    i686-linux = {
      filename = "zig-x86-linux-0.16.0.tar.xz";
      shasum = "4e34e279a9f856358de420490b531974c3d37f8f3707eef9f0342e92c14c301f";
      size = 58196012;
    };

    loongarch64-linux = {
      filename = "zig-loongarch64-linux-0.16.0.tar.xz";
      shasum = "2503be8ecc5965f1f7962471d267d9f83fcb3cc2f7ff78ac34093b9722bbea93";
      size = 52515080;
    };

    s390x-linux = {
      filename = "zig-s390x-linux-0.16.0.tar.xz";
      shasum = "14db4884b31414bd637879036c1e6e335f3ba44ccac59df104163728a0cab30e";
      size = 54995144;
    };
    ...
    aarch64-mingw32 = {
      filename = "zig-aarch64-windows-0.16.0.zip";
      shasum = "aee38316ee4111717900f45dd3130145c39289e105541d737eb8c5ed653c78ef";
      size = 93109828;
    };

    i686-mingw32 = {
      filename = "zig-x86-windows-0.16.0.zip";
      shasum = "8aee7e8a8deb998ba96cb95d89aa5fcdf32933fdc67de51d280d9e4d7396f1a0";
      size = 99015159;
    };

    aarch64-freebsd = {
      filename = "zig-aarch64-freebsd-0.16.0.tar.xz";
      shasum = "0a441f50696a34cfb9f9a0b3c510fd49a56b18b364e03c26525cb7999959c969";
      size = 51137568;
    };

    armv7l-freebsd = {
      filename = "zig-arm-freebsd-0.16.0.tar.xz";
      shasum = "78b2a7bfa74f504075dd4b5c00418347a21b893f0eae580cf4e56c553cf181f6";
      size = 52741336;
    };

    powerpc64le-freebsd = {
      filename = "zig-powerpc64le-freebsd-0.16.0.tar.xz";
      shasum = "46b3fa0239be42669d86ce8394f8de2d608a4f51e3e65cb8222bfd543b95e310";
      size = 55232224;
    };

    riscv64-freebsd = {
      filename = "zig-riscv64-freebsd-0.16.0.tar.xz";
      shasum = "aefbaea44f32bde07118f5522b7bb21de9967a6d09183e3e37b1f5be2c78f948";
      size = 55416052;
    };

    x86_64-freebsd = {
      filename = "zig-x86_64-freebsd-0.16.0.tar.xz";
      shasum = "390379bfaf6b89b001c6bb4035b8fcbc5c12193fd9fd5048c3a0fe39e5d1cf72";
      size = 55591888;
    };

    aarch64-netbsd = {
      filename = "zig-aarch64-netbsd-0.16.0.tar.xz";
      shasum = "4767425d72c779275ebbc5a6319f5a3c5d109664d3d8c880125d550e87d9d46a";
      size = 51104512;
    };

    armv7l-netbsd = {
      filename = "zig-arm-netbsd-0.16.0.tar.xz";
      shasum = "07aaa403c18e9fa33687a3eb3109bb484a96aece95a4f6792a911d2eefac07c5";
      size = 53772868;
    };

    i686-netbsd = {
      filename = "zig-x86-netbsd-0.16.0.tar.xz";
      shasum = "aa36c02caad52d92e6354baec16dd866642e64b7c30e4d515806c8296d65586f";
      size = 58792260;
    };

    x86_64-netbsd = {
      filename = "zig-x86_64-netbsd-0.16.0.tar.xz";
      shasum = "e235ca96f63034a009aca831c69394a1c14498a8e06ff5f358fc3fb4bed73dfb";
      size = 55533332;
    };

    aarch64-openbsd = {
      filename = "zig-aarch64-openbsd-0.16.0.tar.xz";
      shasum = "f3c868ccc1bc30e2d2b68128186b2153d86c3efc41190f4170a43024a3cd7809";
      size = 51564888;
    };

    armv7l-openbsd = {
      filename = "zig-arm-openbsd-0.16.0.tar.xz";
      shasum = "33786d6487aaeca9f300e5a932d5ee5365d9254be0add44b3af8f6db8441ca2f";
      size = 52301840;
    };

    riscv64-openbsd = {
      filename = "zig-riscv64-openbsd-0.16.0.tar.xz";
      shasum = "ffb74aefa8184a4b886f8c0a9105db00ac9562d502330f4e764a7a49171e4f8e";
      size = 55734756;
    };

    x86_64-openbsd = {
      filename = "zig-x86_64-openbsd-0.16.0.tar.xz";
      shasum = "25b72946e8b2dde5c93bc03cbebeb17e4d90eea8040acce8bb78cefdeee97337";
      size = 56962688;
    };
  };
